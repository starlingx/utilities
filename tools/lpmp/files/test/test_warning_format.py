...
########################################################################
"""
Test script to check the exact format of warnings in summary.timing
"""
...
class TestWarningFormat(LPMPTestBase):
    """Test the exact format of warnings in summary.timing"""
